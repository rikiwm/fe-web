...
<div class="items-center px-4 py-10 mb-4 text-sm place-content-center">
    <!-- Session Status -->
    <x-auth-session-status class="mb-4" :status="session('status')" />

    <form wire:submit="login" class="gap-4 space-y-6">
        <!-- Email Address -->
        <div>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="bg-green-900 ms-3">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
